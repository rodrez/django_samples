 ...
 * @param {string} options.value - The value to be validated.
 * @param {RegExp} options.regex - The regex to be used for validation.
 * @param {string} options.cellType - The type of cell to be validated.
 * @returns {Object} An object with the validation result and message.
 * @returns {boolean} Object.isValid - Whether the value is valid.
 * @returns {string} Object.message - The validation message.
 * @example
 * validate({ value: "abc", regex: /^[a-zA-Z0-9]+$/g, cellType: "header" });
 * // returns { isValid: true, message: "abc - is valid" }
 */
